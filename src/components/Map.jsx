...
const Map = () => {
    ...
    const captureMapSnapshot = () => {
        if (mapInstanceRef.current) {
            ...
            const staticMapUrl = `https://maps.googleapis.com/maps/api/staticmap?center=${center.lat()},${center.lng()}&zoom=${zoom}&size=900x700&maptype=${mapType}&markers=color:red%7C${center.lat()},${center.lng()}&key=${apiKey}`;
